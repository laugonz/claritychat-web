...
const route = (path: string, meta: Omit<PageMeta, "canonical">, element: ReactElement): Route => ({
  path,
  meta: { ...meta, canonical: `${SITE.url}${path}` },
  element,
});
...
export const ROUTES: Route[] = [
  ...
  route("/guides/", {
    title: "Text & Relationship Analysis Guides | Clarity Chat",
    description: "Context-first guides for analyzing texts, mixed signals, ghosting and concerning communication without pretending to read minds.",
    image: `${SITE.url}/assets/guides/how-to-analyze-text-messages-feature.jpg`,
    jsonLd: guidesIndexJsonLd(),
    sitemapPriority: "0.9",
  }, <GuidesIndex />),
  ...guides.map((guide) => route(`/guides/${guide.slug}/`, {
    title: guidePageTitles[guide.slug] ?? `${guide.title} | Clarity Chat`,
  ...
  route("/privacy/", {
    ...
    description: "How Clarity Chat processes selected chat screenshots, protects conversation content and handles purchases.",
    image: `${SITE.url}/assets/icon.png`,
    jsonLd: webPageJsonLd("Clarity Chat privacy policy", "How Clarity Chat processes selected chat screenshots and protects conversation content.", "/privacy/"),
    sitemapPriority: "0.3",
  }, <PrivacyPage />),
  route("/terms/", {
    title: "Terms of Use | Clarity Chat",
    description: "Read the terms for using Clarity Chat as a personal AI-assisted conversation reflection tool, including safety, purchases and service limits.",
    image: `${SITE.url}/assets/icon.png`,
    jsonLd: webPageJsonLd("Clarity Chat terms of use", "Terms for using Clarity Chat as a personal conversation reflection tool.", "/terms/"),
    sitemapPriority: "0.3",
  }, <TermsPage />),
  route("/support/", {
    title: "Support | Clarity Chat",
    description: "Get help with Clarity Chat analyses, screenshot uploads, purchase restoration and app access, with guidance on what to include in a support request.",
    image: `${SITE.url}/assets/icon.png`,
    jsonLd: webPageJsonLd("Clarity Chat support", "Get help with Clarity Chat analyses, purchases and app access.", "/support/"),
    sitemapPriority: "0.3",
  }, <SupportPage />),
];
